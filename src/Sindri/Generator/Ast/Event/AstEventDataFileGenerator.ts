...
export class AstEventDataFileGenerator extends AstFileGenerator implements EventDataFileGeneratorContract {
    ...
    public generateFile(
        ...
        const data = [
            ...
            `import { Listener } from '@valkyrja/valkyrja/Event/Data/Listener.js';`,
            `import type { ListenerContract } from '@valkyrja/valkyrja/Event/Data/Contract/ListenerContract.js';`,
            userImportsBlock,
