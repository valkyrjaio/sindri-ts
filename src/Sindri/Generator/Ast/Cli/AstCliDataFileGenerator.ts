...
export class AstCliDataFileGenerator extends AstFileGenerator implements CliDataFileGeneratorContract {
    ...
    public generateFile(
        ...
        const data = [
            ...
            `import { ArgumentParameter } from '@valkyrja/valkyrja/Cli/Routing/Data/ArgumentParameter.js';`,
            `import { OptionParameter } from '@valkyrja/valkyrja/Cli/Routing/Data/OptionParameter.js';`,
            `import { ArgumentMode } from '@valkyrja/valkyrja/Cli/Routing/Enum/ArgumentMode.js';`,
            `import { ArgumentValueMode } from '@valkyrja/valkyrja/Cli/Routing/Enum/ArgumentValueMode.js';`,
            `import { OptionMode } from '@valkyrja/valkyrja/Cli/Routing/Enum/OptionMode.js';`,
            `import { OptionValueMode } from '@valkyrja/valkyrja/Cli/Routing/Enum/OptionValueMode.js';`,
