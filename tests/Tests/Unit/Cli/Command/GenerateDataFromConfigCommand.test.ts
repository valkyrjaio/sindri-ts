...
const configPath = fileURLToPath(new URL('../../../Fixtures/App/ConfigFixture.ts', import.meta.url));
...
describe('GenerateDataFromConfigCommand', () => {
    ...
    it('still runs the generators when the config has no providers', () => {
        const emptyConfig = fileURLToPath(new URL('../../../Fixtures/Config/TestConfigNoClassFixture.ts', import.meta.url));
