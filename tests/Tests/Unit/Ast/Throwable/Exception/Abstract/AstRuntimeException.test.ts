...
import { AstRuntimeException } from '../../../../../../../src/Sindri/Ast/Throwable/Exception/Abstract/AstRuntimeException.ts';

class TestException extends AstRuntimeException {}

describe('AstRuntimeException', () => {
