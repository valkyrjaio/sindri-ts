...
import { SindriRuntimeException } from '../../../../../../src/Sindri/Throwable/Exception/Abstract/SindriRuntimeException.ts';

class TestException extends SindriRuntimeException {}

describe('SindriRuntimeException', () => {
